...
Design pattern is some kind of cooking recipe. It’s time-tested approach of solving common problems in software development and not even there. 

Use patterns like you are playing chess. Design patterns simplify communication between developers.

Creational, structural and behavioral patterns

Creational patterns focus on how you handle creating new objects. They make creation of objects suitable to current situation.

Structural describe how objects are connected with each other. Think of a structural pattern like a food dish with a combination of flavor pairs. 

Behavioral patterns focus on how objects distribute work and how each of them works toward common goal. Think of behavioral pattern like a race car pit crew at a track. Everybody has his own responsibility but all together they are working on the same goal.

But remember if you have a hammer in your hands, then all the objects around begin to look like nails. Patterns are not universal. 
